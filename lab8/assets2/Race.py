...
bg = pygame.image.load('assets2/AnimatedStreet.png').convert_alpha()
myCar = pygame.image.load('assets2/Player.png').convert_alpha()
myCar = pygame.transform.scale(myCar, (50, 100))
enemyCar = pygame.image.load('assets2/Enemy.png').convert_alpha()
enemyCar = pygame.transform.scale(enemyCar, (50, 100))
coin = pygame.image.load('assets2/coin.png').convert_alpha()
FPS = pygame.time.Clock()
pygame.display.set_caption("Race")   
font = pygame.font.SysFont("Verdana", 60)
accident_sound=pygame.mixer.Sound('assets2/caracc.mp3')
