...
screen = pygame.display.set_mode((1180, 1200))

pygame.display.set_caption("Mickey Clock")

mike = pygame.image.load('assets1/clockk.jpg').convert_alpha()
left = pygame.image.load('assets1/arrow.png').convert_alpha()
right = pygame.image.load('assets1/arrow.png').convert_alpha()
...
while running:
    ...
    minute_hand_rect = minute_hand_rotated.get_rect(center=(590, 630))
    ...
    second_hand_rect = second_hand_rotated.get_rect(center=(590, 630))
